...
config :ai_agent_advisor, AiAgentAdvisorWeb.Endpoint,
  url: [host: "localhost"],
  adapter: Bandit.PhoenixAdapter,
  render_errors: [
    formats: [html: AiAgentAdvisorWeb.ErrorHTML, json: AiAgentAdvisorWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: AiAgentAdvisor.PubSub,
  live_view: [signing_salt: "/ct208tZ"]
...
config :ai_agent_advisor, AiAgentAdvisor.Mailer, adapter: Swoosh.Adapters.Local
